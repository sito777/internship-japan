...
if(isset($_GET['page']) && !empty($_GET['page'])){ //als de page empty is dan
    $pages = ['registreren', 'login', 'home','over','wachtwoord-vergeten', 'contact','stageplek-profiel', 'profiel-pagina', 'profiel-pagina-update', 'profiel-pagina-delete', 'profiel-pagina-create','logout'];
